...
📅️ **Última actualização**: 27 de Novembro de 2020, 21:38
...
+ `data_concelhos_14.csv` e `data_concelhos_ecdc.csv` contém dados de confirmados do acumulado dos 14 dias anteriores à data, no primeiro ficheiro, e proporcional a 100k habitantes no segundo ficheiro. Inclui os dados do `data_concelhos.csv` desde que os daddos são semanais, nomeadamente entre 27-07-2020 (correspondendo a 13 a 26) até 26-10-2020, e será actualizado conforme seja disponibilizado pela DGS (semanalmente à segunda-feira).  
