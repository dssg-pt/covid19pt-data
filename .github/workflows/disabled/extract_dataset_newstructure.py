...
def extract_data(reports, original_dataframe):
    ...
    for report in reports:
        ...
        try:
            ...
            confirmados_arsnorte_value, obitos_arsnorte_value, confirmados_arscentro_value,
            obitos_arscentro_value, suspeitos_value, confirmados_value, n_confirmados_value, lab_value,
            recuperados_value, obitos_value, vigilancia_value, confirmados_arslvt_value, obitos_arslvt_value,  
           ...
           # ] = get_all_numbers_from_list(lines, "Total de casos", "Região de residência")
            ...
            [suspeitos_value, confirmados_value, n_confirmados_value, lab_value, recuperados_value,
            obitos_value, vigilancia_value, confirmados_arslvt_value, obitos_arslvt_value,  #recuperados_arslvt_value,
            confirmados_arsalentejo_value, obitos_arsalentejo_value, confirmados_arsalgarve_value, obitos_arsalgarve_value
            ] = get_all_numbers_from_list(lines, "Casos recuperados", "Região de residência")
...
#        index_last_row = original_dataframe.index[original_dataframe['data'] == report["date"]].tolist()[0] - 1
        ...
        try:
            ...
            try:
                ...
                confirmados_0_9_m_value=np.nan
                confirmados_10_19_m_value=np.nan
                confirmados_20_29_m_value=np.nan
                confirmados_30_39_m_value=np.nan
                confirmados_40_49_m_value=np.nan
                confirmados_50_59_m_value=np.nan
                confirmados_60_69_m_value=np.nan
                confirmados_70_79_m_value=np.nan
                confirmados_80_plus_m_value=np.nan
                desconhecidos_m_value=np.nan
                confirmados_0_9_f_value=np.nan
                confirmados_10_19_f_value=np.nan
                confirmados_20_29_f_value=np.nan
                confirmados_30_39_f_value=np.nan
                confirmados_40_49_f_value=np.nan
                confirmados_50_59_f_value=np.nan
                confirmados_60_69_f_value=np.nan
                confirmados_70_79_f_value=np.nan
                confirmados_80_plus_f_value=np.nan
                desconhecidos_f_value=np.nan
...
def get_all_numbers_from_list(lines, string_bottom, string_upper):
    ...
    print("From {0} to {1}: {2}".format(string_bottom, string_upper, numbers))
