...
if __name__ == '__main__':
    ...
    URL = "https://services.arcgis.com/CCZiGSEQbAxxFVh3/arcgis/rest/services/An%C3%A1lises_Extra_Covid/FeatureServer/0/query?f=json&Amostras_Novas&where=Confirmados%3E0&returnGeometry=false&spatialRel=esriSpatialRelIntersects&outFields=*&orderByFields=Data_do_Relat%C3%B3rio%20desc&resultOffset=0&resultRecordCount=318&cacheHint=true"
